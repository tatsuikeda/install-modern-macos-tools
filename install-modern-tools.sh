...
echo "  tree --version   # should print a version"
echo "  jq --version     # should print a version"
echo "  yq --version     # should print a version"
echo "  htop --version   # should print a version"
echo "  tmux -V          # should print a version"
